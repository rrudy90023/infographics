...
class ActiveMobileConnections extends React.Component {
	...
	render(){
		...
		var checker = this.state.data === "No data available" ? <div style={{'width':'100%', 'textAlign':'center'}}><span style={{'position': 'relative', 'display': 'inline-block', 'height': '100px', 'color': '#f08817', 'fontSize': '24px', 'fontWeight': '200!important', 'top':'60px'}}>No data available</span></div> : <div><img src="https://rudes-media.s3.us-west-1.amazonaws.com/infog/images/icons/carrier.svg" style={{'width': '100px', 'position': 'relative', 'display': 'inline-block', 'height': '150px', 'top': '46px'}} alt="" /><div style={{'width': '40%', 'position': 'relative', 'display': 'inline-block', 'height': '100px', 'color': '#f08817', 'fontSize': '75px', 'fontWeight': '100!important'}}><span style={{'fontSize':'11px', 'color':'#000', 'position':'relative', 'fontWeight':'600!important', 'display':'block', 'top':'3px', 'letterSpacing':'2px', 'width':'100%'}}>3G/4G</span><div style={{'width':'100%', 'margin':'0', 'padding':'0', 'position':'relative', 'display':'inline-block', 'top':'0px'}}>{this.state.data}%</div></div></div>;
